= Antora UI for BDWare
// Settings:
:experimental:
:hide-uri-scheme:
// Project URLs:
:url-project: https://github.com/BDWare/antora-ui
...
== BDWare Customizations

=== https://github.com/Mogztter/antora-lunr[antora-lunr] integration

Check https://github.com/Mogztter/antora-lunr/tree/master/supplemental_ui for UI changes

Added UI files:

- link:src/css/search.css[]
- link:src/js/vendor/lunr.js[]
- link:src/js/vendor/search.js[]

Merged UI files:

- link:src/partials/footer-scripts.hbs[]
- link:src/partials/head-meta.hbs[]
- link:src/partials/header-content.hbs[]
